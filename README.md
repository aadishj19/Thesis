...
A SLURM script to batch process data in chunks, utilizing `process_chunk.py` and `combine_results.py`.

### process_chunk.py

Performs data processing tasks on a specified chunk of data. Calls functions from `src.data_processing` to analyze light curves.
